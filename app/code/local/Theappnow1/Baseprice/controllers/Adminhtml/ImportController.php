...
//                    $product['store'] = "web2";
                    // $product['simples_sku'] = '';
                    $product['Do you want to add print or embroidery service?:checkbox:0:1'] = '1x Embroidery logo:fixed:5|2x Embroidery logo:fixed:9|1x Printing Logo:fixed:4|2x Printing Logo:fixed:7';
                    $product['Is this a new setup or is a repeat artwork job?:checkbox:0:2'] = 'New logo artwork setup:fixed:0|Repeat artwork job:fixed:0';
