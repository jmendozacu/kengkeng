...
class ABSoft_Import_Adminhtml_ImportController extends Mage_Adminhtml_Controller_Action
{

	protected function _isAllowed()
	{
		//return Mage::getSingleton('admin/session')->isAllowed('import/importbackend');
		return true;
	}
                    ...
                    foreach ($post['mapFields'] as $k => $code) {
                        ...
                        switch ($code){
                            ...
                            case 'short_description':
                                ...
                                break;
                            case 'categories':
                                if(strpos($row[$k],'[ROOT_CATEGORY]')!==false){
